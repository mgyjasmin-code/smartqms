...
6. Cancellation requires the private management link and a token-authorized session; use a neutral verification error.
...
- cancellation rejects invalid or expired private management links;
