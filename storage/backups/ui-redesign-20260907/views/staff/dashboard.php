  ...
  <div class="staff-dashboard">
    ...
    <section class="staff-ops-panel staff-current-panel admin-card admin-table-card" aria-labelledby="currently-serving-title">
      <header class="staff-ops-heading admin-card-header">
        <div><i data-lucide="volume-2" aria-hidden="true"></i><h2 id="currently-serving-title">Now Serving / Calling</h2></div>
      </header>
      ...
      <div class="staff-table-wrap table-responsive" role="region" aria-label="Current ticket; scroll horizontally to view all columns" tabindex="0">
          ...
          <thead><tr><th>Queue #</th><th>Service</th><th>Type</th><th>Arrived</th><th>Called</th><th>Status</th><th class="text-end">Actions</th></tr></thead>
          <tbody>
            <?php if ($current): ?>
              <tr>
                ...
                <td>
                  ...
                  <?php if ($currentLifecycle === 'calling'): ?>
                    <small class="staff-inline-timer" data-void-timer><strong data-void-countdown
                      ...
                      data-void-url="<?= APP_URL ?>/modules/queue/void_checker.php">00:00</strong> remaining</small>
                  <?php endif; ?>
                </td>
                <td>
            ...
            <?php else: ?>
              <tr><td colspan="7"><div class="staff-table-empty"><i data-lucide="radio" aria-hidden="true"></i><div><strong>No active ticket</strong><span>Call the first eligible waiting ticket when the counter is ready.</span></div></div></td></tr>
            <?php endif; ?>
          </tbody>
        </table>
      </div>
